...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm mb-4">
    <div class="container">
        <a class="navbar-brand font-weight-bold text-primary" href="../index.php">SkillConnect</a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="../user/cursos.php">Cursos</a></li>
                <li class="nav-item"><a class="nav-link" href="../user/vagas.php">Vagas</a></li>
                <li class="nav-item"><a class="nav-link" href="../user/contato.php">Contato</a></li>
            </ul>
            ...
            <ul class="navbar-nav">
                <?php if (!$isLogado): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../auth/register.php"><i class="fas fa-user-plus"></i> Criar Conta</a>
                    </li>
                <?php else: ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="perfilDropdown">
                            <a class="dropdown-item" href="../user/meus-dados.php"><i class="fas fa-id-card"></i> Meus Dados</a>
                            <?php if ($perfil === 'admin'): ?>
                                <a class="dropdown-item" href="../admin/admin.php"><i class="fas fa-cogs"></i> Painel Admin</a>
                                <a class="dropdown-item" href="../admin/listarclientes.php"><i class="fas fa-users"></i> Listar Usuários</a>
                            <?php endif; ?>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-danger" href="../auth/logout.php"><i class="fas fa-sign-out-alt"></i> Sair</a>
                        </div>
                    </li>
                <?php endif; ?>
            </ul>
